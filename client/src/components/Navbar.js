...
function Navbar() {
  ...
  //   Axios.post("https://etsy-prototype.herokuapp.com/getAllProducts/1", variables).then(
  //     (response) => {
    ...
    <div>
      ...
      <header className="navBar">
        <a style={{ marginLeft: "3%", textDecoration: "none" }} href="/home">
          <h2 className="logo"><img src ={"https://upload.wikimedia.org/wikipedia/commons/8/89/Etsy_logo.svg"} alt = "logo" width="84" height="43"/></h2>
        </a>
        <SearchBar
